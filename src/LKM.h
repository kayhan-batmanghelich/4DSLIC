...
typedef    VectorImageType::PixelType             vecPixelType ;
...
public:
	...
	void DoSupervoxelSegmentation(
       ...
       void DoSupervoxelSegmentationForMultichannelVolume(
...
private:
	...
	void PerformLKMVoxelClustering(
        ...
        // Kayhan: added clustering for multi-channel images
	void PerformLKMVoxelClustering(
		VectorImageType::Pointer		vecImg,
